    ...
    return(
      ...
      <Fade>
        ...
        <div className="container">
          ...
          <h1 className="text-primary" style={{fontSize:"6.2em"}} >RESIDENTADO</h1>
          <h1 className="display-2 text-warning">2024</h1>
            </div>
            <div className="col-4">
            <div className="col-sm " >
            <div className=" text-white " style={{ display: "inline-block", borderRadius: "80px", backgroundImage: "linear-gradient(270deg, rgba(0,103,224,0.9864320728291317) 37%, rgba(15,197,236,0.9556197478991597) 100%)" }}>
...
aliquip ex ea commodo consequat.</p>
            ...
            <div className="col-1 " >
        <div className="mx-4" style={{borderLeft:'1px solid yellow', height:'100%'}}></div>
        </div>
            <div className="col">
...
aliquip ex ea commodo consequat.</p>
      ...
      >
        <div className="col-3 d-flex flex-column align-items-center justify-content-center text-center" style={{ fontSize: "1em",...(window.innerWidth <= 768 ? estiloResponsive : {}) }}>
          <div className="pb-3 px-3 rounded-circle" style={{ ...estilo  }}>
            <AiOutlineLike />
          </div>
        ...
        <div className="container">
            ...
            <br/><br/>
            <p className="lead text-center text-primary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
